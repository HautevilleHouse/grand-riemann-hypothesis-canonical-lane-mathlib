# Grand Riemann Hypothesis — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/grand-riemann-hypothesis-canonical-lane-mathlib.git
cd grand-riemann-hypothesis-canonical-lane-mathlib
lake exe
lake build
```
